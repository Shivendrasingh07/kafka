...
//func (srv *Server) ProcessChunk(r *http.Request) error {
//
...
//	if err != nil {
//		return fmt.Errorf("failed to upload the file on cloud %w", err)
//	}
//
...
//
//	chunk.Data = part
//	chunk.ByteData, err = json.Marshal(part)
//	if err != nil {
//		return nil, fmt.Errorf("failed to marshal chunk part %w", err)
//	}
//	return &chunk, nil
//}
//
